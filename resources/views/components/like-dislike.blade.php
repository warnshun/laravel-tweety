<div class="flex">
    <form method="POST" action="/tweets/{{ $tweet->id }}/like">
        ...
        <div class="flex items-center mr-4 {{ $tweet->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-300' }}">
    ...
    <form method="POST" action="/tweets/{{ $tweet->id }}/like">
        ...
        <div class="flex items-center {{ $tweet->isDislikedBy(current_user()) ? 'text-blue-500' : 'text-gray-300' }}">
            <svg viewBox="0 0 20 20"
                class="mr-1 w-3"
            >
                <g id="Page-1"
